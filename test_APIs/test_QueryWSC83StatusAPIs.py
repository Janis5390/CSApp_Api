...
from api_objects.QueryWSC83StatusAPIs import queryWSC83StatusAPIs
...
# #讀取Excel 
file_path = 'test_data/QueryWSC83StatusAPIs.xlsx'
name = '工作表1'
...
def test_CustomerInfoAPIs(data_dict,get_session):
    ...
    try:
        #呼叫API
        call_api = queryWSC83StatusAPIs(get_session)
