...
from api_objects.QueryROAMWStatusAPIs import queryROAMWStatusAPIs
...
# #讀取Excel 
file_path = 'test_data/QueryROAMWStatusAPIs.xlsx'
name = '工作表1'
...
def test_CustomerInfoAPIs(data_dict,get_session):
    ...
    try:
        #呼叫API
        call_api = queryROAMWStatusAPIs(get_session)
